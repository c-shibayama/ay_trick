...
def Help():
  ...
  Usage: tsim2.est01x_exp1b'''

def Run(ct,*args):
  main_script= 'tsim2.est01c'
  #basedir='{home}/data/tsim2est01/EST01_Eb_2017_06_19/'
  basedir='{home}/data/tsim2est01b/EST01_Eb_2017_07_12/'
  ...
  common= {
    ...
    'num_log_interval': 1,
    'config': {},
    'dpl_options': {  #Added for a fair comparison with EST01_True
      'ddp_sol': {'db_init_ratio': 0.0,},
      }
    }
  ##test:
  #basedir='/tmp/tsim2est01/EST01_Eb_2017_06_19/'
  #num_runs= 1
  #common['num_episodes']= 2
