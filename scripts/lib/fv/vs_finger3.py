...
def Help():
  ...
  Usage:
    fv.vs_finger3 'setup' [, ARM1 [, ARM2]]
      Start to subscribe topics, setup services.
      ARM*: LEFT, RIGHT, or 'all' (both arms). Default: 'all'
    fv.vs_finger3 'rec' [, RID [, ARM1 [, ARM2]]]
      Start/stop recording.
      RID: Recoding ID.
      ARM*: LEFT, RIGHT, or 'all' (both arms). Default: 'all'
    fv.vs_finger3
    fv.vs_finger3 'clear' [, ARM1 [, ARM2]]
      Stop to subscribe topics.
      ARM*: LEFT, RIGHT, or 'all' (both arms). Default: 'all'
    fv.vs_finger3 'frame_skip', SKIP [, ARM1 [, ARM2]]
      Set frame-skip to SKIP.
      SKIP: Frames to be skipped. 0: No skip.
      ARM*: LEFT, RIGHT, or 'all' (both arms). Default: 'all'
    fv.vs_finger3 'clear_obj' [, ARM1 [, ARM2]]
      Clear detected object models.
      ARM*: LEFT, RIGHT, or 'all' (both arms). Default: 'all'
    fv.vs_finger3 'stop_detect_obj' [, ARM1 [, ARM2]]
      Stop detecting object.
      ARM*: LEFT, RIGHT, or 'all' (both arms). Default: 'all'
    fv.vs_finger3 'start_detect_obj' [, ARM1 [, ARM2]]
